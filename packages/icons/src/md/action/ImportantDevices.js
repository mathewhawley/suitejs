...
function ImportantDevices(props) {
  return (
    <IconBase viewBox="0 0 48 48" {...props}>
      <path d="M30 18h-6.06L22 12l-1.94 6H14l4.94 3.52-1.88 5.82 4.94-3.6 4.94 3.6-1.88-5.82L30 18zm0 0h-6.06L22 12l-1.94 6H14l4.94 3.52-1.88 5.82 4.94-3.6 4.94 3.6-1.88-5.82L30 18zm16 4.01c1.1 0 2 .89 2 1.99v18c0 1.1-.9 2-2 2H36c-1.1 0-2-.9-2-2V24c0-1.1.9-2 2-2l10 .01zM46 40V26H36v14h10zM40 4H4C1.78 4 0 5.78 0 8v24c0 2.2 1.78 4 4 4h14v4h-4v4h16v-4h-4v-4h4v-4H4V8h36v10h4V8c0-2.22-1.8-4-4-4zM23.94 18L22 12l-1.94 6H14l4.94 3.52-1.88 5.82 4.94-3.6 4.94 3.6-1.88-5.82L30 18h-6.06z" />
    </IconBase>
  );
}
